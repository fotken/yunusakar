...
export interface ApiAnnouncementAnnouncement extends Schema.CollectionType {
  ...
  attributes: {
    ...
    publishedAttext: Attribute.DateTime;
...
export interface ApiBarberBarber extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    name: Attribute.String;
    off_datebarbers: Attribute.Relation<
      'api::barber.barber',
      'oneToMany',
      'api::off-datebarber.off-datebarber'
    >;
...
export interface ApiOffDatebarberOffDatebarber extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    off_date: Attribute.Date & Attribute.Required;
    publishedAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::off-datebarber.off-datebarber',
...
export interface ApiReservationReservation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    note: Attribute.Text;
    publishedAt: Attribute.DateTime;
    reservation_status: Attribute.Enumeration<['Pending', 'Approved', 'Done']>;
    services: Attribute.Relation<
      'api::reservation.reservation',
      'manyToMany',
      'api::service.service'
    >;
    time_slots: Attribute.JSON;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::off-datebarber.off-datebarber': ApiOffDatebarberOffDatebarber;
